...
A GitHub Action copies the source code over to the public =jake-wright-net= repository.
    ...
    steps:
      ...
      - name: Push changes
        run: |
          ...
          cp -a jake-wright-net-src/jake-wright-net/. jake-wright-net/
          cd jake-wright-net
...
Once the public repo is pushed to, the second Cloudflare Pages project builds and deploys the site.
